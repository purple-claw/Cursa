...
Cursa is an L2 VPN similar to a Virtual Switch.
...
- Configure TAP device
    ```
    sudo ip addr add 10.1.1.101/24 dev cursa-dev
    sudo ip link set cursa-dev up
    ```
...
- Configure TAP device
    ```
    sudo ip addr add 10.1.1.102/24 dev cursa-dev
    sudo ip link set cursa-dev up
    ```
...
https://github.com/purple-claw/Cursa/assets/7e4db7a5-88a5-4181-8d5f-dd861e9a040c
